...
//        System.out.println(productInfoPage.getTotalElements());
  ...
  public void save() {
    ...
    productInfo.setProductName("lobster");
    productInfo.setProductPrice(new BigDecimal(31.2));
    productInfo.setProductStock(100);
    productInfo.setProductDescription("taste very good");
  ...
  @Test
  public void onSale() {
    ProductInfo result = productService.onSale("1223");
    Assert.assertEquals(ProductStatusEnum.UP, result.getProductStatusEnum());
  }

  @Test
  public void offSale() {
    ProductInfo result = productService.offSale("1223");
