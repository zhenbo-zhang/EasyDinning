...
<#--This template is used by index a product and add a new product-->
<#--sidebar-->
        ...
        <div class="col-md-12 column">
          <form role="form" method="post" action="/sell/seller/product/save">
            <div class="form-group">
              <label>Name</label>
            <#--Handle cases where productInfo.productName can be null -->
          ...
          <#--Need the product id to update the db, but didn't need to display here-->
